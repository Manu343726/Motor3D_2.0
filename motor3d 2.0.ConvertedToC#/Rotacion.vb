...
#Region "AplicarTransformacion (DEBUGGING)"
        ...
        Public Overloads Shared Function AplicarTransformacion(ByVal Caja As Caja3D, ByVal Rotacion As Rotacion) As Caja3D
            If Rotacion.SobreOrigen Then
                Return New Caja3D(Cuaternion.ObtenerPunto(Rotacion.Cuaternion * New Cuaternion(Caja.Posicion, False) * Not Rotacion.Cuaternion), Caja.Dimensiones)
            Else
                Return Transformacion3D.AplicarTransformacion(Caja, Rotacion)
            End If
        End Function
...
#End Region
        ...
        Public Overloads Shared Operator *(ByVal Rotacion As Rotacion, ByVal Caja As Caja3D) As Caja3D
            Return AplicarTransformacion(Caja, Rotacion)
        End Operator

        Public Overloads Shared Operator *(ByVal Caja As Caja3D, ByVal Rotacion As Rotacion) As Caja3D
            Return AplicarTransformacion(Caja, Rotacion)
        End Operator
