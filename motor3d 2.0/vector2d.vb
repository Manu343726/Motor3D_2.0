...
Namespace Espacio2D
    Public Class Vector2D
        ...
        Public ReadOnly Property CuadradoModulo As Double
            Get
                Return (mX ^ 2) + (mY ^ 2)
            End Get
        End Property
        ...
        Public ReadOnly Property VectorNormal As Vector2D
            Get
        ...
        Public Shared Function ProyeccionOrtogonal(ByVal V1 As Vector2D, ByVal V2 As Vector2D) As Vector2D
        ...
        Public Shared Function Reflejo(ByRef Normal As Vector2D, ByRef Vector As Vector2D) As Vector2D
            Return ((2 * (Normal * Vector)) * Normal) - Vector
        End Function
    End Class
End Namespace
